...
function Drawer({
  ...
  const contextValue = React.useMemo(
    () => ({ hasSnapPoints, modal, showSwipeHandle, swipeDirection, swipeHandleClassName }),
    [hasSnapPoints, modal, showSwipeHandle, swipeDirection, swipeHandleClassName]
  )
...
function DrawerContent({
  ...
  const { hasSnapPoints, modal, showSwipeHandle, swipeDirection, swipeHandleClassName } = useDrawer()
  const swipeAxis =
