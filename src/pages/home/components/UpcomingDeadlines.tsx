...
function DaysBadge({ days, isOverdue, isSoon }: { days: number; isOverdue: boolean; isSoon: boolean }) {
    if (isOverdue) {
        return (
...
export function UpcomingDeadlines({ projects, isLoading }: Props) {
        ...
        return (
            <Card className="w-full min-w-0 max-w-full gap-3 py-4">
                <CardHeader className="gap-1 px-4 pb-0">
                    <CardTitle className="text-base sm:text-lg">Próximos vencimientos</CardTitle>
                    <CardDescription className="text-xs sm:text-sm">Próximos 3 vencimientos de proyectos activos</CardDescription>
                </CardHeader>
    ...
    return (
        <Card className="w-full min-w-0 max-w-full gap-3 py-4">
            <CardHeader className="gap-1 px-4 pb-0">
                <CardTitle className="truncate text-base sm:text-lg">Próximos Vencimientos</CardTitle>
                        ...
                        {upcoming.map((project) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <DaysBadge days={days} isOverdue={isOverdue} isSoon={isSoon} />
                                </button>
                            );
                        })}
                    </div>
